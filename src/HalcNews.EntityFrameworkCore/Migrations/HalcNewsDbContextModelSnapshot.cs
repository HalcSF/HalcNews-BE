...
namespace HalcNews.Migrations
{
    ...
    partial class HalcNewsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FolderNew", b =>
                {
            ...
            modelBuilder.Entity("FolderNewsListE", b =>
                {
                    ...
                    b.Property<int>("NewsListsId")
                        .HasColumnType("int");

                    b.HasKey("FoldersId", "NewsListsId");
            ...
            modelBuilder.Entity("HalcNews.Lecturas.Lectury", b =>
                {
                    ...
                    b.ToTable("AppLecturies", (string)null);
                });
            ...
            modelBuilder.Entity("HalcNews.ListaNoticias.NewsListE", b =>
                {
                    ...
                    b.ToTable("AppNewsList", (string)null);
                });
            ...
            modelBuilder.Entity("HalcNews.Temas.Theme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewNewsListE", b =>
                {
                    b.Property<int>("NewsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FolderNew", b =>
                {
                    b.HasOne("HalcNews.Carpetas.Folder", null)
                        .WithMany()
                        .HasForeignKey("FoldersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HalcNews.Noticias.New", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FolderNewsListE", b =>
                {
                    ...
                    b.HasOne("HalcNews.ListaNoticias.NewsListE", null)
                        .WithMany()
                        .HasForeignKey("NewsListsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
