    ...
    public partial class NuevasTablas : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppNewsList", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "FolderNewsListE",
                columns: table => new
                {
                    FoldersId = table.Column<int>(type: "int", nullable: false),
                    NewsListsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FolderNewsListE", x => new { x.FoldersId, x.NewsListsId });
                    table.ForeignKey(
                        name: "FK_FolderNewsListE_AppFolders_FoldersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FolderNew", x => new { x.FoldersId, x.NewsId });
                    table.ForeignKey(
                        name: "FK_FolderNew_AppFolders_FoldersId",
                        column: x => x.FoldersId,
                        principalTable: "AppFolders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FolderNew_AppNews_NewsId",
                        column: x => x.NewsId,
                        principalTable: "AppNews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewNewsListE", x => new { x.NewsId, x.NewsListsId });
                    table.ForeignKey(
                        name: "FK_NewNewsListE_AppNewsList_NewsListsId",
                        column: x => x.NewsListsId,
                        principalTable: "AppNewsList",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NewNewsListE_AppNews_NewsId",
                        column: x => x.NewsId,
                        principalTable: "AppNews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppAlerts_FolderId",
                table: "AppAlerts",
                column: "FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_AppLecturies_NewId",
                table: "AppLecturies",
                column: "NewId");

            migrationBuilder.CreateIndex(
                name: "IX_AppNews_SourceId",
                table: "AppNews",
                column: "SourceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FolderNewsListE_NewsListsId",
                table: "FolderNewsListE",
                column: "NewsListsId");

            migrationBuilder.CreateIndex(
                name: "IX_NewNewsListE_NewsListsId",
                table: "NewNewsListE",
                column: "NewsListsId");
